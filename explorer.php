...
//if currentdir_Cont is a directoy or a file. Basicly if the path is a file or a folder
        ...
        if(is_dir($currentdir_Cont[$x+2])){
            ...
            //check folder path if its in root and theres a folder named style
            if($_SESSION["currentdir"] ==  getcwd() && $currentdir_Cont[$x+2] == "style"){

            }else{

                echo $number."<".$htmltype_tr." class='".$classname."'><".$htmltype_td."><a href='?dir=".$currentdir_Cont[$x+2]."\\". "'>".
                "<img class=\"filetype\" src=\"style/filetype/svg/".$filetype.".svg\" onerror=\"this.src='style/filetype/svg/blank.svg';\"/><text>"
                .limit_text($currentdir_Cont[$x+2],$titleLenght)."</text></a></".$htmltype_td.">"."<".$htmltype_td." class='filesize'>".formatSizeUnits($filesize)."</".$htmltype_td."> <span style='padding-left:50px;'>"
                .$filetype."</".$htmltype_tr.">";
            ...
            if($_SESSION["currentdir"] ==  getcwd() && $currentdir_Cont[$x+2]=="index.php" ||
               ...
               $_SESSION["currentdir"] ==  getcwd() && $currentdir_Cont[$x+2]=="\style"){
              //nothing echo-ing
            }else{
                ...
                echo $number."<".$htmltype_tr." class='".$classname."'><".$htmltype_td."><a href='".$extrdir.$currentPath.$currentdir_Cont[$x+2]."\\"."'>".
                    "<img class=\"filetype\" src=\"".$filetype."\" onerror=\"this.src='style/filetype/svg/blank.svg';\"/><text>"
                    .limit_text($currentdir_Cont[$x+2],$titleLenght)."</text></a></".$htmltype_td.">"."<".$htmltype_td." class='filesize'>".formatSizeUnits($filesize)."</".$htmltype_td."> <span style='padding-left:100px; '>"
                    .$filetype."</".$htmltype_tr.">";
